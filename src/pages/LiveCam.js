	...
	return (
		<div className='flex flex-col items-center justify-center'>
			...
			<div className='w-[63rem] h-[12rem] flex justify-between'>
				...
				<iframe id="jejuVideo" frameBorder="0" allowFullScreen="1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" title="펀제주 실시간 제주도 날씨 제주 협재 바다 라이브캠  Jeju Island in South Korea Live Cam" width="320" height="180" src="https://www.youtube.com/embed/i3rkCPrVAgM?autoplay=1&amp;rel=0&amp;modestbranding=1&amp;mute=1&amp;enablejsapi=1&amp;origin=http%3A%2F%2Flocalhost%3A3000&amp;widgetid=5" sandbox="allow-same-origin allow-scripts allow-forms allow-popups allow-popups-to-escape-sandbox allow-presentation"></iframe>
			</div>
