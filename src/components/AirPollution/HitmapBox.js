	...
	return (
		<div className='w-[31rem] flex flex-col justify-center h-[17rem] bg-[#ffffff] rounded-md my-[0.5rem]'>
			...
			<div className='w-[31rem] flex justify-center px-5'>
				<iframe className='rounded-lg w-[29rem] h-[12rem] mb-5' src={`https://earth.nullschool.net/ko/#current/particulates/surface/level/overlay=${val}/orthographic=127.868,37.20,1300`}></iframe>
			</div>
		</div>
	)
}
